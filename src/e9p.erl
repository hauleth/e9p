...
-opaque qid() :: #qid{type :: u8(), version :: u32(), path :: u64()}.

-type fid() :: 16#00000000..16#FFFFFFFF.

%-spec make_qid()
make_qid(Type, Version, Path) ->
    #qid{type = to_qtype(Type), version = Version, path = Path}.

is_type(#qid{type = QType}, Type) ->
